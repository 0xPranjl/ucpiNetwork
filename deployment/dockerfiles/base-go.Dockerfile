...
WORKDIR /go/src/github.com/enigmampc/ucpiNetwork
...
RUN mkdir -p /go/src/github.com/enigmampc/ucpiNetwork/go-cosmwasm/target/release/

COPY --from=build-env-rust /go/src/github.com/enigmampc/ucpiNetwork/go-cosmwasm/target/release/libgo_cosmwasm.so /go/src/github.com/enigmampc/ucpiNetwork/go-cosmwasm/target/release/libgo_cosmwasm.so
COPY --from=build-env-rust /go/src/github.com/enigmampc/ucpiNetwork/go-cosmwasm/librust_cosmwasm_enclave.signed.so /go/src/github.com/enigmampc/ucpiNetwork/go-cosmwasm/librust_cosmwasm_enclave.signed.so
COPY --from=build-env-rust /go/src/github.com/enigmampc/ucpiNetwork/go-cosmwasm/librust_cosmwasm_query_enclave.signed.so /go/src/github.com/enigmampc/ucpiNetwork/go-cosmwasm/librust_cosmwasm_query_enclave.signed.so

COPY api_key.txt /go/src/github.com/enigmampc/ucpiNetwork/ias_keys/develop/
COPY spid.txt /go/src/github.com/enigmampc/ucpiNetwork/ias_keys/develop/
COPY api_key.txt /go/src/github.com/enigmampc/ucpiNetwork/ias_keys/production/
COPY spid.txt /go/src/github.com/enigmampc/ucpiNetwork/ias_keys/production/
COPY api_key.txt /go/src/github.com/enigmampc/ucpiNetwork/ias_keys/sw_dummy/
COPY spid.txt /go/src/github.com/enigmampc/ucpiNetwork/ias_keys/sw_dummy/
...
# RUN cp /go/src/github.com/enigmampc/ucpiNetwork/cosmwasm/packages/wasmi-runtime/librust_cosmwasm_enclave.signed.so x/compute/internal/keeper
# RUN mkdir -p /go/src/github.com/enigmampc/ucpiNetwork/x/compute/internal/keeper/.sgx_ucpis
