...
// source: ucpi/compute/v1beta1/types.proto
...
type AccessTypeParam struct {
	Value AccessType `protobuf:"varint,1,opt,name=value,proto3,enum=ucpi.compute.v1beta1.AccessType" json:"value,omitempty" yaml:"value"`
}
...
func init() {
	proto.RegisterEnum("ucpi.compute.v1beta1.AccessType", AccessType_name, AccessType_value)
	proto.RegisterType((*AccessTypeParam)(nil), "ucpi.compute.v1beta1.AccessTypeParam")
	proto.RegisterType((*CodeInfo)(nil), "ucpi.compute.v1beta1.CodeInfo")
	proto.RegisterType((*ContractCustomInfo)(nil), "ucpi.compute.v1beta1.ContractCustomInfo")
	proto.RegisterType((*ContractInfo)(nil), "ucpi.compute.v1beta1.ContractInfo")
	proto.RegisterType((*AbsoluteTxPosition)(nil), "ucpi.compute.v1beta1.AbsoluteTxPosition")
	proto.RegisterType((*Model)(nil), "ucpi.compute.v1beta1.Model")
}

func init() {
	proto.RegisterFile("ucpi/compute/v1beta1/types.proto", fileDescriptor_8ba7f40a6d1951b3)
}
