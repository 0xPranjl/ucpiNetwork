...
// source: ucpi/compute/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ucpi.compute.v1beta1.GenesisState")
	proto.RegisterType((*Code)(nil), "ucpi.compute.v1beta1.Code")
	proto.RegisterType((*Contract)(nil), "ucpi.compute.v1beta1.Contract")
	proto.RegisterType((*Sequence)(nil), "ucpi.compute.v1beta1.Sequence")
}

func init() {
	proto.RegisterFile("ucpi/compute/v1beta1/genesis.proto", fileDescriptor_e737d858048ffc2a)
}
