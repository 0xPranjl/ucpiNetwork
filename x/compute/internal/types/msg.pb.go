...
// source: ucpi/compute/v1beta1/msg.proto
...
func init() {
	proto.RegisterType((*MsgStoreCode)(nil), "ucpi.compute.v1beta1.MsgStoreCode")
	proto.RegisterType((*MsgInstantiateContract)(nil), "ucpi.compute.v1beta1.MsgInstantiateContract")
	proto.RegisterType((*MsgExecuteContract)(nil), "ucpi.compute.v1beta1.MsgExecuteContract")
}

func init() { proto.RegisterFile("ucpi/compute/v1beta1/msg.proto", fileDescriptor_6815433faf72a133) }
