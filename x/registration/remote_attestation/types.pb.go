...
// source: ucpi/registration/v1beta1/remote_attestation/types.proto
...
func init() {
	proto.RegisterType((*QuoteReport)(nil), "ucpi.registration.remote_attestation.v1beta1.QuoteReport")
	proto.RegisterType((*QuoteReportBody)(nil), "ucpi.registration.remote_attestation.v1beta1.QuoteReportBody")
	proto.RegisterType((*QuoteReportData)(nil), "ucpi.registration.remote_attestation.v1beta1.QuoteReportData")
	proto.RegisterType((*EndorsedAttestationReport)(nil), "ucpi.registration.remote_attestation.v1beta1.EndorsedAttestationReport")
	proto.RegisterType((*SGXEC256Signature)(nil), "ucpi.registration.remote_attestation.v1beta1.SGXEC256Signature")
	proto.RegisterType((*PlatformInfoBlob)(nil), "ucpi.registration.remote_attestation.v1beta1.PlatformInfoBlob")
}

func init() {
	proto.RegisterFile("ucpi/registration/v1beta1/remote_attestation/types.proto", fileDescriptor_c8a3a0e7f2a8fa26)
}
