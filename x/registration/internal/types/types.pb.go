...
// source: ucpi/registration/v1beta1/types.proto
...
type RegistrationNodeInfo struct {
	Certificate   github_com_enigmampc_ucpiNetwork_x_registration_remote_attestation.Certificate `protobuf:"bytes,1,opt,name=certificate,proto3,casttype=github.com/enigmampc/ucpiNetwork/x/registration/remote_attestation.Certificate" json:"certificate,omitempty"`
...
func init() {
	proto.RegisterType((*SeedConfig)(nil), "ucpi.registration.v1beta1.SeedConfig")
	proto.RegisterType((*RegistrationNodeInfo)(nil), "ucpi.registration.v1beta1.RegistrationNodeInfo")
}

func init() {
	proto.RegisterFile("ucpi/registration/v1beta1/types.proto", fileDescriptor_f3db05f1d182f4de)
}
