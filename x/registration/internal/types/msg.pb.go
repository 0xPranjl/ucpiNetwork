...
// source: ucpi/registration/v1beta1/msg.proto
...
import (
	...
	github_com_enigmampc_ucpiNetwork_x_registration_remote_attestation "github.com/enigmampc/ucpiNetwork/x/registration/remote_attestation"
...
type RaAuthenticate struct {
	...
	Certificate github_com_enigmampc_ucpiNetwork_x_registration_remote_attestation.Certificate `protobuf:"bytes,2,opt,name=certificate,proto3,casttype=github.com/enigmampc/ucpiNetwork/x/registration/remote_attestation.Certificate" json:"ra_cert"`
}
...
func init() {
	proto.RegisterType((*RaAuthenticate)(nil), "ucpi.registration.v1beta1.RaAuthenticate")
	proto.RegisterType((*MasterCertificate)(nil), "ucpi.registration.v1beta1.MasterCertificate")
	proto.RegisterType((*Key)(nil), "ucpi.registration.v1beta1.Key")
}

func init() {
	proto.RegisterFile("ucpi/registration/v1beta1/msg.proto", fileDescriptor_91e653c4cfa6dfea)
}
