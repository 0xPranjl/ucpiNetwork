...
// source: ucpi/registration/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryEncryptedSeedRequest)(nil), "ucpi.registration.v1beta1.QueryEncryptedSeedRequest")
	proto.RegisterType((*QueryEncryptedSeedResponse)(nil), "ucpi.registration.v1beta1.QueryEncryptedSeedResponse")
}

func init() {
	proto.RegisterFile("ucpi/registration/v1beta1/query.proto", fileDescriptor_7ee71413f073b37c)
}
...
func (c *queryClient) TxKey(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Key, error) {
	out := new(Key)
	err := c.cc.Invoke(ctx, "/ucpi.registration.v1beta1.Query/TxKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RegistrationKey(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Key, error) {
	out := new(Key)
	err := c.cc.Invoke(ctx, "/ucpi.registration.v1beta1.Query/RegistrationKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EncryptedSeed(ctx context.Context, in *QueryEncryptedSeedRequest, opts ...grpc.CallOption) (*QueryEncryptedSeedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ucpi.registration.v1beta1.Query/EncryptedSeed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_TxKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ucpi.registration.v1beta1.Query/TxKey",
	}
...
func _Query_RegistrationKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ucpi.registration.v1beta1.Query/RegistrationKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_EncryptedSeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ucpi.registration.v1beta1.Query/EncryptedSeed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ucpi.registration.v1beta1.Query",
	...
	Metadata: "ucpi/registration/v1beta1/query.proto",
}
