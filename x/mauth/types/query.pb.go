...
// source: ucpi/intertx/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryInterchainAccountFromAddressRequest)(nil), "ucpi.intertx.v1beta1.QueryInterchainAccountFromAddressRequest")
	proto.RegisterType((*QueryInterchainAccountFromAddressResponse)(nil), "ucpi.intertx.v1beta1.QueryInterchainAccountFromAddressResponse")
}

func init() {
	proto.RegisterFile("ucpi/intertx/v1beta1/query.proto", fileDescriptor_9777b436e70abcdd)
}
...
func (c *queryClient) InterchainAccountFromAddress(ctx context.Context, in *QueryInterchainAccountFromAddressRequest, opts ...grpc.CallOption) (*QueryInterchainAccountFromAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ucpi.intertx.v1beta1.Query/InterchainAccountFromAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_InterchainAccountFromAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ucpi.intertx.v1beta1.Query/InterchainAccountFromAddress",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ucpi.intertx.v1beta1.Query",
	...
	Metadata: "ucpi/intertx/v1beta1/query.proto",
}
