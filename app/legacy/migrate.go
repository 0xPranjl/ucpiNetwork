...
import (
	...
	legacy120 "github.com/enigmampc/ucpiNetwork/app/legacy/v120"
)
...
Example:
$ ucpid migrate /path/to/genesis.json --chain-id=ucpi-4 --genesis-time=2019-04-22T17:00:00Z --initial-height=5000
`,
