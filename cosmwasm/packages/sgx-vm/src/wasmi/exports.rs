        ...
        .map(|answer| -> Result<EnclaveBuffer, OcallReturn> {
            match answer {
                Ok((system_result, gas_cost)) => {
                    ...
                    // see CosmWasm's implementation https://github.com/enigmampc/ucpiNetwork/blob/508e99c990dd656eb61f456584dab054487ba178/cosmwasm/packages/sgx-vm/src/imports.rs#L124
